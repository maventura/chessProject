...
public class Game
{
	...
	public string[,] types = new string[2, 8] {
	...
	public int contW = 600;
	public int contB = 600;
	public float _timerW = 0;
	public float _timerB = 0;
	public UI_TextField txtTimeWhites;
	public UI_TextField txtTimeBlacks;
	...
	void updateTime ()
	{
		...
		if (_timerW >= 1) {
			...
			mins = contW / 60;
			secs = contW % 60;
			txtTimeWhites.text = "W: " + mins + " : " + secs;
			if (contW <= 0) {
			...
			mins = contB / 60;
			secs = contB % 60;
			txtTimeBlacks.text = "B: " + mins + " : " + secs;
			if (contB <= 0) {
	...
	void spawnTimers ()
	{
		txtTimeWhites = new UI_TextField ("ARIAL", 15, "ffffff");
		txtTimeWhites.x = 10;
		txtTimeWhites.y = 150;
		txtTimeWhites.text = "W: 0 : 0";
		txtTimeBlacks = new UI_TextField ("ARIAL", 15, "ffff00");
		txtTimeBlacks.x = 10;
		txtTimeBlacks.y = 180;		
		txtTimeBlacks.text = "B: 0 : 0";
	}
	public void FinishGame (string winner)
	{
		UI_TextField txtFinish;
		txtFinish = new UI_TextField ("ARIAL", 15, "ff0000");
		txtFinish.x = Screen.width / 2 - txtFinish.width;
		txtFinish.y = Screen.height / 2 - txtFinish.width;
		if (turnAlign) {
